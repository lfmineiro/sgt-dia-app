...
const grupoEscalaValido = <T extends EscalaComServicoRef>(escalas: T[]): boolean => {
...
export const intervaloHorariosValido = (
  ...
  return (
    duracao >= DURACAO_CICLO_EM_MINUTOS &&
    duracao % DURACAO_CICLO_EM_MINUTOS === 0
  );
};
...
export const selecionarEscalasDoServicoAlvo = <T extends EscalaComServicoRef>(
  escalas: T[],
): T[] => {
